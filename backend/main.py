...
def create_app():
    ...
    if not db_url:
        # Esta verificação é boa, mas a mantemos simples por enquanto.
        # Se o app falhar, será por causa da conexão, o que é um bom indicador.
        logging.warning("DATABASE_URL não encontrada, a aplicação pode falhar ao acessar o DB.")
    ...
    @app.route("/")
    def home():
        return jsonify({"message": "Crypton Signals API v15.0 (IT WORKS!)", "status": "online"})
