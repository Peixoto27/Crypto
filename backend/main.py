...
def create_app():
    ...
    # Configurações
    cache_config = {"CACHE_TYPE": "SimpleCache", "CACHE_DEFAULT_TIMEOUT": 21600}  # 6h de cache
    ...
    with app.app_context():
        ...
        def get_technical_signal(symbol):
            try:
                ...
                if df_daily.empty:
                    raise Exception("DataFrame diário vazio.")
                ...
                # Volatility squeeze alert usando Bandas de Bollinger
        ...
        @app.route("/")
        def home():
            return jsonify({"message": "Crypton Signals API v10.1 (Sinais Ajustados)", "status": "online"})
